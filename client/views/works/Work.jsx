             ...
             <div className="container v-align-transform header-container">
                 <div className="row">
                     ...
                     <div className="col-sm-12 left">
                       ...
                       <a href="/">
                         <h3 className="work-author">{this.work.author}</h3>
                       </a>

                       <a href="/">
                         <h2 className="card-title work-title">{this.work.title}</h2>
                       </a>
                       <a href="/">
                         <p className="work-editor">{this.work.editor}, {this.work.year}</p>
                       </a>
